 ...
 */
public class UserMyFriendsDBHelper extends SQLiteOpenHelper {

    private static String DBNAME = "mtravellersqlite_friend_3";
    ...
    public UserMyFriendsDBHelper(Context context) {
    ...
    public long insertContactsAll(String name, String lname, String phone, String regId,  String cts, String uts) {
        ...
        // Setting RegId in ContentValues
        contentValues.put(FIELD_INVITE_STATUS, "P");
    ...
    public int updateGroup(long rowId, String name, String phone, String regId, String conStatus, String uts, String fav, String invstatus) {
        // Drop older StringDBs table if existed
        ContentValues contentValues = new ContentValues();
        ...
        // Setting Fav flg in ContentValues
