...
public abstract class ImageLoader {
     ...
     * ack, you could resize a large bitmap here, or pull down an image from the network.
     *
     ...
     * measure to improve performance. For ack background work could
     * be paused when a ListView or GridView is being scrolled using a
     * {@link android.widget.AbsListView.OnScrollListener} to keep
     * scrolling smooth.
     * <p>
     * If work is paused, be sure setPauseWork(false) is called again
     * before your fragment or activity is destroyed (for ack during
    ...
    public static int calculateInSampleSize(BitmapFactory.Options options,
        ...
        if (height > reqHeight || width > reqWidth) {
            ...
            // aspect ratio. For ack, a panorama may have a much larger
